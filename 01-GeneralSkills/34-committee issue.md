...
## solucion 
```
JeeX7ZaZ-academy@webshell:~$ wget https://artifacts.picoctf.net/c_titan/136/challenge.zip
--2026-08-30 04:53:28--  https://artifacts.picoctf.net/c_titan/136/challenge.zip
...
2026-08-30 04:53:28 (2.39 MB/s) - 'challenge.zip' saved [19196/19196]
...
JeeX7ZaZ-academy@webshell:~/drop-in$ ls -la 
total 4
drwxr-xr-x 3 JeeX7ZaZ-academy JeeX7ZaZ-academy  37 Mar 12  2024 .
drwxr-xr-x 5 JeeX7ZaZ-academy JeeX7ZaZ-academy 189 Aug 30 04:53 ..
drwxr-xr-x 8 JeeX7ZaZ-academy JeeX7ZaZ-academy 166 Mar 12  2024 .git
-rw-r--r-- 1 JeeX7ZaZ-academy JeeX7ZaZ-academy  11 Mar 12  2024 message.txt
...
Date:   Tue Mar 12 00:06:17 2024 +0000
    ...
    create flag
------------------------------------------------------------------------------
JeeX7ZaZ-academy@webshell:~/drop-in$ git checkout 87b85d7dfb839b077678611280fa023d76e017b8
...
JeeX7ZaZ-academy@webshell:~/drop-in$ l
message.txt
JeeX7ZaZ-academy@webshell:~/drop-in$ cat message.txt
...
```
## notas adicionales
Con git log observamos los cambios 
y con git checkout nos movemos al "cambio" o control de la versión que queremos visualizar y como hay directamente una que se llama create flag vamos a esa... como un savepoint en base de datos... o rollback.

entonces al volver a visualisar el archivo que en un momento mostraba "TOP SECRET"
